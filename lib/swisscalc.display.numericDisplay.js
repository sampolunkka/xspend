...
global.swisscalc.display.numericDisplay = function (groupDigits, maxLength) {
  this._display = "0";
  this._groupDigits = typeof groupDigits === "undefined" ? false : groupDigits;
  this._maxLength = typeof maxLength === "undefined" ? 5 : maxLength;
};

// Returns current display
global.swisscalc.display.numericDisplay.prototype.getCurrentDisplay =
  function () {
...
global.swisscalc.display.numericDisplay.prototype.getDisplayValue =
  function () {
